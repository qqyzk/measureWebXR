...
export class TooltipCallNode extends React.PureComponent<Props> {
  ...
  _maybeRenderOneCategoryGroup(
    ...
    if (countPositiveValues(subcategoryBreakdown) <= 1) {
      ...
      console.log('category 2', getCategoryPairLabel(categories, category, subCategory));
      rows.push(
  ...
  render() {
    ...
    console.log('catefory 3',getCategoryPairLabel(
      categories,
      categoryIndex,
      subcategoryIndex
    ))
